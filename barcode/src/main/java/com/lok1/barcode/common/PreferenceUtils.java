...
package com.lok1.barcode.common;
...
public class PreferenceUtils {
  ...
  public static void showDetectionInfo(Context context) {
    String prefKey =
        context.getString(R.string.pref_key_info_hide);
    PreferenceManager.getDefaultSharedPreferences(context)
            .edit()
  ...
  public static void hideDetectionInfo(Context context) {
    String prefKey =
        context.getString(R.string.pref_key_info_hide);
    PreferenceManager.getDefaultSharedPreferences(context)
            .edit()
  ...
  public static boolean shouldHideDetection(Context context) {
    SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
    String prefKey =
            context.getString(R.string.pref_key_hide);
    return sharedPreferences.getBoolean(prefKey, false);
  }

  public static void showDetection(Context context) {
    String prefKey =
        context.getString(R.string.pref_key_hide);
    PreferenceManager.getDefaultSharedPreferences(context)
            .edit()
  ...
  public static void hideDetection(Context context) {
    String prefKey =
        context.getString(R.string.pref_key_hide);
    PreferenceManager.getDefaultSharedPreferences(context)
            .edit()
