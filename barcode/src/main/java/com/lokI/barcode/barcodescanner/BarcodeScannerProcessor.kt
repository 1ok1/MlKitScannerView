...
package com.lokI.barcode.barcodescanner
...
import com.lokI.barcode.ScanInfo
import com.lokI.barcode.common.VisionProcessorBase
import com.lokI.barcode.common.GraphicOverlay
import com.lokI.barcode.common.PreferenceUtils

/** Barcode Detector Demo.  */
class BarcodeScannerProcessor(var context: Context, var scanInfo: ScanInfo) : VisionProcessorBase<List<Barcode>>(context) {
    ...
    override fun onSuccess(barcodes: List<Barcode>, graphicOverlay: GraphicOverlay) {
        ...
        for (i in barcodes.indices) {
            ...
            if (!PreferenceUtils.shouldHideDetection(context))
                graphicOverlay.add(BarcodeGraphic(graphicOverlay, barcode))
            scanInfo.qrCode(barcode.displayValue ?: "")
